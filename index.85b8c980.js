...
})({"7rJ2j":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "e2a49a4685b8c980";
"use strict";
...
const renderCarousel = (images)=>{
    ...
    images.forEach(({ src , alt  }, i1)=>{
        const slide = document.createElement("div");
        slide.setAttribute("class", "slide" + `${i1 === activeSlide ? " active" : ""}`);
...
const renderImageSelectors = (count)=>{
    ...
    for(i = 0; i < count; i++){
        ...
        if (i === activeSlide) selector.setAttribute("class", "active");
...
window.onload = async ()=>{
    const images = await (0, _api.fetchData)();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"dAKlO"}],"dAKlO":[function(require,module,exports) {
...
},{}]},["7rJ2j","iP1vB"], "iP1vB", "parcelRequireb531")

//# sourceMappingURL=index.85b8c980.js.map
